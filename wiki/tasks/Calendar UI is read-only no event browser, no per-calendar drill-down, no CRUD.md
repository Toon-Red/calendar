...
WHAT: Calendar UI is read-only: no event browser, no per-calendar drill-down, no CRUD
HOW: As a user maintaining 21 calendars, I want a UI to browse events, add/edit/delete events, and rename/delete calendars.
